...
public class Silly implements Comparable<Silly>{
     ...
     */
    public Silly(String word, String word2) {
        /**
         * Overload of Silly in the case that Silly recieves two string inputs
         * sets this.name equal to the concatenation of the two strings
         */

        this.name = word + word2;
    }
